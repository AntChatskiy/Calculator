import unittest
from calculator import Calculator, Parser
...
class CalculatorTestCase(unittest.TestCase):
    ...
    def test_errors(self):
        ...
        for expression in errors:
            self.assertEqual(calculator.main(expression), errors[expression])
    ...
    def test_simple(self):
        ...
        for expression in simple:
            self.assertEqual(calculator.main(expression), simple[expression])
    ...
    def test_normal(self):
        ...
        for expression in normal:
            self.assertEqual(calculator.main(expression), normal[expression])
    ...
    def test_difficult(self):
        ...
        for expression in difficult:
            self.assertEqual(calculator.main(expression), difficult[expression])
    ...
    def test_float(self):
        ...
        for expression in expressions:
            self.assertEqual(calculator.main(expression), expressions[expression])
